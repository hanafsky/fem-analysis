...
詳細なセットアップ手順は `skills/fem-skill/references/project_setup.md` を参照してください。
...
プロジェクトの完全なセットアップ（React ビューア、vite 設定など）は [`skills/fem-skill/references/project_setup.md`](skills/fem-skill/references/project_setup.md) を参照してください。
